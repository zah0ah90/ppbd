                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive ">
                            ...
                            <form method="POST" action="{{ route('peserta-update', $peserta->id) }}">
                                ...
                                <div class="row my-gallery">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                <br>
                                                <label class="text-danger">Tidak Ada Foto/ Belum Upload Kartu Keluarga
                                                </label>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                <br>
                                                <label class="text-danger">Tidak Ada Foto/ Belum Upload Siswa Siswa
                                                </label>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="status">
                                                <option value="1" {{ $peserta->status == '1' ? 'selected' : '' }}>Di
                                                    Terima
                                                </option>
                                                <option value="0" {{ $peserta->status == '0' ? 'selected' : '' }}>Di
                                                    Tolak
                                                </option>
                                                <option value="2" {{ $peserta->status == '2' ? 'selected' : '' }}>Di
                                                    Proses
                                                </option>
                                                <option value="3" {{ $peserta->status == '3' ? 'selected' : '' }}>
                                ...
                                <button type="submit" id="update-data" class="btn btn-primary">Update Data</button>
                            </form>
                        </div>
                        <!-- /.card-body -->
                    </div>
