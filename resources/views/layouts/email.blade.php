<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                SDN <span
                                                    style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 7px;">NEGERI
                                                    NURUL SALAM</span>
                                            </td>
                                        </tr>
        ...
        <tr>
            <td align="center">
                <table class="col-600" width="600" border="0" height="300" align="center" cellpadding="0"
                    cellspacing="0" style="margin-left:20px; margin-right:20px;  border: 1px solid #dbd9d9;">
                    <tbody>
                        @yield('content')
                            ...
                            <td align="center" valign="top" {{--
                                ...
                                <table class="col-600" width="600" height="100" border="0" align="center"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                style="font-family: 'Raleway', sans-serif; font-size:12px; color:#ffffff; font-weight: bold;">
                                                ANDRI AGUSTINA <span
                                                    style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 7px;"></span>
                                            </td>
                                        </tr>
